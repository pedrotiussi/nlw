...
class PointsController {
    ...
    async create(request: Request, response: Response) {
        ...
        const point = {
            image: 'https://images.unsplash.com/photo-1550989460-0adf9ea622e2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=100&q=80',
            name,
            email,
            whatsapp,
            latitude,
    ...
    async index(request: Request, response: Response) {
        ...
        const points = await knex('points')
            ...
            .whereIn('point-items.item_id', parsedItem)
